...
export function RoomCard({ room, onJoin }: RoomCardProps) {
  const langColor = languageColors[room.language.toLowerCase()] || "bg-muted text-muted-foreground"
...
export function RecentRooms({ rooms, onJoinRoom, onViewAll }: RecentRoomsProps) {
  ...
  return (
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h2 className="text-xl font-semibold text-foreground">Recent Rooms</h2>
        <button 
          onClick={onViewAll}
