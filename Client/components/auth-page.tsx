        ...
        <div className="relative z-10 flex flex-col justify-between h-full py-12 px-12 xl:px-20">
          ...
          <div className="glass rounded-xl p-4 font-mono text-sm mt-8">
            ...
            <pre className="text-muted-foreground">
              <code>
                <span className="text-cursor-pink">const</span> <span className="text-cursor-blue">team</span> = <span className="text-warning">[</span><span className="text-success">&quot;you&quot;</span>, <span className="text-success">&quot;me&quot;</span><span className="text-warning">]</span>;{"\n"}
                <span className="text-cursor-pink">await</span> <span className="text-cursor-blue">collaborate</span>(team);
              </code>
            </pre>
          </div>
        </div>
